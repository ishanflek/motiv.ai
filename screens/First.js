...
function First({navigation}) {
  ...
  return (
      <ScrollView style={{backgroundColor: "#1c1c1cff"}} showVerticalScrollIndicator={false}>
        <View className="bg-stone-900 flex flex-col items-center " style={{paddingLeft: width*0.06, paddingRight: width*0.06, paddingTop: height/18}}>
          ...
          <CheckBox
            ...
            style={{marginLeft: width*0.05, marginRight: width*0.06}}
            />
            <Text className="shrink text-white-0" style={{marginTop:height/122, marginBottom: height/102, fontSize: 12 / fs, width: width*0.9, marginRight: width*0.1}}>
