  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      <ScrollView showVerticalScrollIndicator={false} contentContainerStyle={{ flexGrow: 1 }}>
        <View className="bg-stone-900 flex flex-col items-center " style={{ paddingLeft: 24, paddingRight: 26, paddingTop: 50, paddingBottom: 142, height: '100%' }}>
          <Image style={{ marginTop: 40 }} source={require('../assets/243_2380.png')} alt="" />
          <Text className="text-white-0 text-left" style={{ marginTop: 11, fontSize: 57 / fs }}>
            motiv.ai
          </Text>
          <Text
            className="shrink text-white-0 text-center"
            style={{ width: 180, marginTop: 28, fontSize: 12 / fs }}
          >
            Before you can start using our services, please read and agree to our terms and conditions.
          </Text>
          <View className="flex flex-row items-center justify-between w-full" style={{ marginTop: 125 }}>
            <CheckBox
              disabled={false}
              value={checked}
          ...
          <Button className="w-full" style={{ marginTop: 19 }} onPress={handleContinue} mode="contained" labelStyle={{ padding: 5 }}>
            Continue
          </Button>
        </View>
      </ScrollView>
